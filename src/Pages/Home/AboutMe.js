...
const AboutMe = () => {
    return (
        <div class=" min-h-screen bg-base-100 my-10">
          <h3 className='text-center mb-20 text-3xl font-semibold'>About Me</h3>
         <div className='grid md:grid-cols-2 justify-center item-center'>
            <div>
                <img className='block mx-auto mb-10 w-[300px] ' src={profile} alt="" />
            </div>
            <div>
                 <h2 className='text-3xl font-semibold'>I'm a web <span className='text-rose-500'>Developer</span></h2>
